...
urlpatterns = [
    ...
    path("createblog/", CreatePostView.as_view(), name="createblog"),
    path("blogs/", ListPostView.as_view(), name="blogs"),
    path("post/<int:pk>/delete/", DeletePostView.as_view(), name="delete-blog"),
    path("post/<int:pk>/update/", UpdatePostView.as_view(), name="update-blog"),
    path("post/new/", CommentCreateView.as_view(), name="new-comment"),
